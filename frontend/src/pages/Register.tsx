    ...
    >
      ...
      >
        ...
        <div style={{ textAlign: 'center', marginBottom: '28px' }}>
          ...
          <h2 style={{ fontSize: '22px', fontWeight: 700, color: 'var(--text-primary)' }}>Create Account</h2>
          <p style={{ fontSize: '13px', color: 'var(--text-muted)', marginTop: '4px' }}>
            Set up your private student print queue
          </p>
        </div>
        ...
        <div style={{ textAlign: 'center', marginTop: '24px', fontSize: '13px', color: 'var(--text-muted)' }}>
          Already registered?{' '}
          <Link to="/login" style={{ color: 'var(--accent-sage)', fontWeight: 600 }}>
            Sign in
          </Link>
        </div>
      </div>
